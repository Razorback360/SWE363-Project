      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6 lg:p-12">
        ...
        <div className="flex flex-col space-y-4 text-left">
          ...
          <div className="flex space-x-4">
            <a
              href="#"
              className="px-4 py-2 text-[#ffffff] bg-[#0F62FE] hover:bg-blue-700 rounded-md font-semibold"
            >
              Donate now
            </a>
            <a
              href="#"
              className="px-4 py-2 text-blue-600 border border-blue-600 hover:bg-blue-50 rounded-md font-semibold"
            >
              Learn more
            </a>
          </div>
